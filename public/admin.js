...
(function () {
  ...
  const MESA_NUMBERS = Array.from({ length: 20 }, (_, i) => String(i + 1));
  ...
  /**
   * Opciones del combo: Sin mesa + Mesa de Alahya + 1–20.
  ...
  function populateFilterMesas(list) {
    ...
    // Siempre incluir Mesa de Alahya y 1–20 en el filtro
